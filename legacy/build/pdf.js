...
var PDFPageProxy = /*#__PURE__*/function () {
  ...
  _createClass(PDFPageProxy, [{
    ...
    value: function _destroy() {
      ...
      var _iterator5 = _createForOfIteratorHelper(this._intentStates.values()),
          _step5;

      try {
        for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
          var intentState = _step5.value;
  ...
  _createClass(LoopbackPort, [{
    ...
    value: function postMessage(obj, transfers) {
      ...
      this._deferred.then(function () {
        var _iterator13 = _createForOfIteratorHelper(_this7._listeners),
            _step13;
...
var AnnotationStorage = /*#__PURE__*/function () {
  ...
  _createClass(AnnotationStorage, [{
    ...
    value: function getValue(key, defaultValue) {
      ...
      return (_this$_storage$get = this._storage.get(key)) !== null && _this$_storage$get !== void 0 ? _this$_storage$get : defaultValue;
    }
  }, {
    key: "setValue",
...
var pdfjsVersion = '2.11.176';
var pdfjsBuild = '07e233d08';
{
  if (_is_node.isNodeJS) {
